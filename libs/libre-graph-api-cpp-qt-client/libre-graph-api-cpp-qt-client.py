...
class subinfo(info.infoclass):
    def setTargets(self):
        for ver in ["v0.11.0", "v0.12.0", "v0.13.2", "v1.0.1"]:
            self.svnTargets[ver] = f"https://github.com/picloud/libre-graph-api-cpp-qt-client.git||{ver}"
            self.targetConfigurePath[ver] = "client"

        for ver in ["1.0.3", "1.0.4"]:
            self.targets[ver] = f"https://github.com/picloud/libre-graph-api-cpp-qt-client/archive/refs/tags/v{ver}.tar.gz"
            self.targetConfigurePath[ver] = "client"
        ...
        self.svnTargets["main"] = f"https://github.com/picloud/libre-graph-api-cpp-qt-client.git|main|"
        ...
        self.webpage = "https://picloud.dev/libre-graph-api/"
